...
import { toadBnbFarm, tokenABI, toadAddress } from '../farms_config.json'
export default {
  components: {
    flipcard: FlipCard
  },
  ...
  methods: {
    ...
    async loadInstances () {
          ...
          this.tokenAddress = toadBnbFarm.tokenAddress
          this.contractAddress = toadBnbFarm.contractAddress
          this.contractABI = toadBnbFarm.contractABI
    ...
    async getROI(){
      const instance = new this.web3.eth.Contract(tokenABI, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c')
