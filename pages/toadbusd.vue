      ...
      <template slot="front">
        <v-card
          ...
          <div class="text-center">
            ...
            <img class="farm-img" :src="farm_img" style="height:85px; margin-top:-3px; margin-bottom:-3px">
            <div class="farm-rewards">{{rewards}}</div>
            <span class="farm-rewards-caption">Toad Earned</span>
            <h5 class="stats-line">
              <img :src="token_img" style="height:25px">
              {{farm_token}} Balance
            ...
            <v-divider style="margin-left: 2%; width: 96%;"></v-divider>
            <h5 class="stats-line">
              <img :src="toad_img" style="height:25px">
              Daily ROI
...
import { toadBusdFarm, tokenABI, toadAddress } from '../farms_config.json'
export default {
  components: {
    flipcard: FlipCard
  },
  ...
  data () {
    return {
      ...
      farm_title: 'TOAD-BUSD',
      farm_token: 'TOAD-BUSD',
      farm_img: '/busd.png',
  ...
  methods: {
    ...
    async loadInstances () {
          ...
          this.tokenAddress = toadBusdFarm.tokenAddress
          this.contractAddress = toadBusdFarm.contractAddress
          this.contractABI = toadBusdFarm.contractABI
    ...
    async getROI(){
      const instance = new this.web3.eth.Contract(tokenABI, '0xe9e7cea3dedca5984780bafc599bd69add087d56')
      let contractBalance = await instance.methods.balanceOf('0x15aff98391f928693F55b70b8F4D787031Ad6f74').call()
      let totalSupply = await this.tokenInstance.methods.totalSupply().call()
      let toadBalance = await this.toadInstance.methods.balanceOf('0x15aff98391f928693F55b70b8F4D787031Ad6f74').call()
