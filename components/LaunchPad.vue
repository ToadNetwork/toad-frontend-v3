...
<!--   <div class="text-center">
  ...
  order-md="1">
    <div class="text-background">
      <div class="paragraph">
        <a href="https://padswap.toad.network/launchpad/" target="_blank" class="green-link">LaunchPAD</a> is our own multi-chain token creation platform, allowing anyone to launch a token on PadSwap with no coding experience.
      </div>
      <div class="paragraph">
  ...
  <div class="launchpad-animation">
    ...
    <div class="rocket">
      <img src="../static/launchpad-animation/rocket.png">
    </div>
  </div>
  </v-col>
  </v-row>
