  ...
  <v-row align="center" justify="center">
      ...
      md="6">
        <div class="bridge-animation">
          ...
          <div class="rock"></div>
          <img class="truck" src="../static/bridge-animation/truck.png">
          <img class="wheels" src="../static/bridge-animation/wheels.png">
        </div>
      </v-col>
      <v-col
      cols="12"
      ...
      <div class="text-background">
        <div class="paragraph">
          Our <a href="https://padswap.toad.network/bridge" target="_blank" class="green-link">cross-chain bridge</a> allows users to easily TOAD between chains, with a simple and intuitive UI.
        </div>
        <div class="paragraph">
        ...
        <br>
        <div class="text-center">
          <a class="" href="https://padswap.toad.network/bridge" target="_blank">
