  ...
  <v-row align="center" justify="center" style="margin-top: 40px">
    ...
    md="6">
      <div class="text-background">
        <div class="paragraph">
        Whenever a transaction takes place on PADSwap, a portion of the fees go to <a href="https://v2.padswap.exchange/vault/" target="_blank" class="green-link">the Vault</a>.
        </div>
        <div class="paragraph">
